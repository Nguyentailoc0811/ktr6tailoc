...
public class MainActivity extends AppCompatActivity {
    ...
    private  List<Country> getListData() {
        ...
        Country canada = new Country("Canada", "ca", 38369302);
        Country cuba = new Country("Cuba", "cu", 11313516);
        Country brazil = new Country("Brazil", "br", 215422967);
